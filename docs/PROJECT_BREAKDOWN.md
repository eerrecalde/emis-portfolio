...
| P2-07 | Define the skill list and years of experience; use that shared data to replace the current combined skill pills wherever skills appear. | In progress | P2-05, P2-06 |
