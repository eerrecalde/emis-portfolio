...
export function ProjectCard({
  ...
  return (
    <li className="group overflow-hidden rounded-xl border border-slate-800 bg-slate-950/65 transition duration-200 hover:-translate-y-1 hover:border-slate-600 hover:shadow-xl hover:shadow-indigo-950/30 focus-within:border-cyan-400/70">
      <Link
