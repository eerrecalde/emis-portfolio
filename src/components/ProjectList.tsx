    ...
    <ul className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      {projects.map((project) => (
        ...
        >
          ...
          <div className="p-5">
            <Heading className="text-xl font-semibold tracking-tight text-slate-50">
              <Link
                className="focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-300"
            ...
            <Link
              ...
              className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-cyan-300 transition hover:text-cyan-100 focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-300"
              to={`/projects/${project.slug}`}
            >
